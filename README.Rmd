...
Basically:
  ...
  * You press `F9` when you are done with a pipeline step (it replaces "enter" or "return", 
which you use only on the last step of a pipeline).
...
of the form `->` at the end of the pipeline.  This is, however, one of the features that makes
